function [validationPredictions, validationScores, trainedClassifier] = trainClassifierSubspaceDiscriminant(trainingData)
...
trainedClassifier.RequiredVariables = {'COV_BreathingRate', 'Duty_Cycle_InhalePause', 'Duty_Cycle_inhale'};
