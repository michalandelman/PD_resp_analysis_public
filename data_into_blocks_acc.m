function [raw_in_block]= data_into_blocks_acc(block_length_in_minutes,sliding_window,Data_wake,SeparateNost,StartPoint,how_long)
...
if SeparateNost
    raw_data=Data_wake(StartPoint:end,[6 7 8]);
else
    raw_data=Data_wake(StartPoint:end,6)+Data_wake(StartPoint:end,7)+Data_wake(StartPoint:end,8);
end
